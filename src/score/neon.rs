...
#[cfg(target_arch = "aarch64")]
unsafe fn fast_log_approx_neon(x: std::arch::aarch64::float32x4_t) -> std::arch::aarch64::float32x4_t {
...
#[cfg(target_arch = "aarch64")]
unsafe fn fast_sqrt_approx_neon(x: std::arch::aarch64::float32x4_t) -> std::arch::aarch64::float32x4_t {
    use std::arch::aarch64::{
