#!/bin/bash
python ./scripts/candidate_scoring.py \
    ...
    --spec_lib_path /Users/georgwallmann/Documents/data/alphadia_performance_tests/output/alphadia-ng-scoring/astral_lf/speclib_flat_calibrated.hdf \
