...
fn test_optimized_observation_creation() {
    let obs = QuadrupoleObservationNextGen::new_with_capacity(
        [100.0, 150.0],
        10,
        1000,
        5000
...
fn test_peak_data_building() {
    ...
    assert_eq!(obs.intensities, vec![1000.0, 1100.0, 1400.0, 2200.0, 2300.0, 2500.0, 2700.0]);
...
fn test_edge_cases() {
    ...
    let mut obs2 = QuadrupoleObservationNextGen::new_with_capacity(
        [200.0, 250.0],
        3,
        1,
        0
...
fn test_isolation_window_validation() {
    let obs1 = QuadrupoleObservationNextGen::new_with_capacity(
        [500.0, 600.0],
        15,
        100,
        1000
    ...
    let obs2 = QuadrupoleObservationNextGen::new_with_capacity(
        [300.5, 325.8],
        8,
        50,
        200
