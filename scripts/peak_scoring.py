...
class PeakScoring:
    def __init__(
        ...
        self.prepare_spec_lib(precursor_df, fragment_df, rt_column, precursor_mz_column, fragment_mz_column, mobility_column)
    ...
    def prepare_spec_lib(self, precursor_df, fragment_df, rt_column, precursor_mz_column, fragment_mz_column, mobility_column):
    ...
    def parse_candidates(self, candidates):
        ...
        candidates_df = candidates_df.merge(
            self.precursor_df[['precursor_idx', 'elution_group_idx', 'decoy']], on='precursor_idx', how='left'
        )
