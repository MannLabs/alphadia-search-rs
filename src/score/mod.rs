...
#[cfg(target_arch = "aarch64")]
pub fn axis_log_dot_product_simd(array: &Array2<f32>, weights: &Vec<f32>) -> Array1<f32> {
...
#[cfg(target_arch = "aarch64")]
pub fn axis_sqrt_dot_product_simd(array: &Array2<f32>, weights: &Vec<f32>) -> Array1<f32> {
